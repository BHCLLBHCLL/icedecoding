...
SLOT_MAP = {
    ...
    "New board": "_import_idf",
    "Update board": "_import_idf",
    "Import IDX file": "_import_idf",
    "Export IDF file": "_export_idf",
    "Import Networks": "_import_networks",
    "Export Networks": "_export_networks",
    "Import JEDEC PTD/JEP30 file": "_import_jedec",
    "Export JEDEC PTD/JEP30 file": "_export_jedec",
    "ANSYS Electronics Desktop script": "_export_aedt",
    "Gradient Firebolt p2i file": "_export_powermap:i2p",
    "Cadence TPKG file": "_export_powermap:ctm",
    ...
    "Gradient Firebolt i2p file": "_import_powermap:i2p",
    "RedHawk CTM profile": "_import_powermap:ctm",
    "Volumetric heat losses": "_em_mapping:volumetric",
    "Surface heat losses": "_em_mapping:surface",
    "Show metal fractions": "_show_metal_fractions",
    "Display powermap property": "_show_powermap",
    # Post
