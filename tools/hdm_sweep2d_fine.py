# -*- coding: utf-8 -*-
"""P18d refinement pass around (shell_factor, tol_factor) = (0.8, 0.3)."""
import json
import os
import sys
import time
...
def main():
    pairs = [(0.7, 0.3), (0.9, 0.3), (0.8, 0.25), (0.8, 0.35),
             (0.75, 0.28), (0.85, 0.32)]
    out = []
    for sf, tf in pairs:
        try:
    ...
    pout = os.path.join(ROOT, "tools", "probe_work", "hdm_sweep2d_fine.json")
